...
def choose_vault(region):
    ...
    if index == 2:
        vaults = get_all_vaults(region)
        vault_name_list = [vault['VaultName'] for vault in vaults]
...
def create_vault(region):
    ...
    while True:
        ...
        elif vault_name in [vault['VaultName'] for vault in vaults]:
